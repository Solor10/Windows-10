        ...
        <div class="row">
            ...
            <div class="title col-12">
                <h2 class="align-left mbr-fonts-style display-1">
                    ...
                    $id = $_REQUEST["id"];
                    $seleccionar = "SELECT * FROM lugar WHERE id='$id'";
                    $guardar = $conexion -> query($seleccionar);
                    $ver = $guardar -> fetch_assoc();
                    ?>
                <form action="../../../assets/basedatos/ubicaciones/actualizar.php?id=<?php echo $ver["id"];?>" method="post">
                <h3 class="align-left mbr-fonts-style m-0 display-5">
                Escribe aqui el nombre del lugar <br>
                <input type="text" name="nombreubi" id="nombreubi" required autocomplete="off" value="<?php echo $ver['nombre'];?>" >
            ...
            <div class="col-12 col-md-6">
                <div class="left-block wrapper">
                    <div class="b b-adress">
                        ...
                        <input type="text" name="direubi" id="direubi" required autocomplete="off" value="<?php echo $ver['direccion'];?>">
                        </p>
                    </div>
                    <div class="b b-phone">
                        ...
                        <p class="mbr-text align-left mbr-fonts-style display-7">
                            <input type="tel" name="teleubi" id="teleubi" required autocomplete="off" value="<?php echo $ver['telefono'];?>">
                        </p>
                    </div>
                    <div class="b b-mail">
                        <h5 class="align-left mbr-fonts-style m-0 display-5">
                        ...
                        <p class="mbr-text align-left mbr-fonts-style display-7">
                        <input type="email" name="correubi" id="correubi" required autocomplete="off" value="<?php echo $ver['correo'];?>">
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <input type="text" class="form-control" id="exampleFormControlTextarea1" required rows="3" name="ubi" value="<?php echo $ver['ubicacion'];?>">
            </div>

            <input type="submit" value="Actualizar Sitio" class="btn btn-outline-primary">
            </form>
